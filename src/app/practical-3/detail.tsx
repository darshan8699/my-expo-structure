...
import { calculateGridDimensions, generateBoxes, getNextColorState } from '@/pages/practical-3/detail/detail.util'
            ...
            <ScrollView style={styles.container} contentContainerStyle={styles.content}>
                ...
                <View style={styles.legendCard}>
                    ...
                    <View style={styles.legendRow}>
                        <View style={styles.legendItem}>
                            <View
                                style={[styles.legendColorBox, { backgroundColor: '#FFFFFF', borderColor: '#CBD5E1' }]}
                            />
                            <Text style={styles.legendText}>1st: Default</Text>
                        </View>
                        <View style={styles.legendItem}>
                            <View
                                style={[styles.legendColorBox, { backgroundColor: '#4F46E5', borderColor: '#4338CA' }]}
                            />
                            <Text style={styles.legendText}>2nd: Indigo</Text>
                        </View>
                        <View style={styles.legendItem}>
                            <View
                                style={[styles.legendColorBox, { backgroundColor: '#10B981', borderColor: '#059669' }]}
                            />
                ...
                <View style={styles.gridContainer}>
                    {boxes.map((item) => {
                        ...
                        const boxStyle =
                            state === 1 ? styles.boxState1 : state === 2 ? styles.boxState2 : styles.boxState0
                        const textStyle =
                            state === 1 ? styles.boxText1 : state === 2 ? styles.boxText2 : styles.boxText0
                        return (
                            <TouchableOpacity
                                key={item.id}
                                activeOpacity={0.7}
