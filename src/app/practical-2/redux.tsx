    ...
    <View style={styles.container}>
      ...
      <View style={styles.counterCard}>
        ...
        <View style={styles.row}>
          <TouchableOpacity style={[styles.btn, styles.btnOutline]} onPress={() => store.dispatch({ type: 'DECREMENT' })}>
            <Text style={styles.btnOutlineText}>−</Text>
          </TouchableOpacity>
          <TouchableOpacity style={[styles.btn, styles.btnPrimary]} onPress={() => store.dispatch({ type: 'INCREMENT' })}>
      ...
      <View style={styles.codeBox}>
        ...
        <Text style={styles.code}>{`const store = createStore(reducer)\nstore.dispatch({ type: 'INCREMENT' })\nstore.subscribe(() => setState(store.getState()))`}</Text>
      </View>
    </View>
  );
}
