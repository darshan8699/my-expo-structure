    ...
    return (
        ...
        >
            ...
            <View style={styles.form}>
                ...
                {/* Forgot Password */}
                <TouchableOpacity style={styles.forgotBtn} onPress={() => router.push('/practical-1/forgot-password')}>
                ...
                {/* Signup Link */}
                <TouchableOpacity style={styles.signupBtn} onPress={() => router.push('/practical-1/signup')}>
