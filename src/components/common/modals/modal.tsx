...
const AppModal: React.FC<AppModalProps> = ({
    ...
    return (
        <Modal testID={testID} transparent visible={visible} animationType="fade" onRequestClose={onClose}>
                ...
                <View style={[styles.modalContainer, containerStyle]}>
                    {!!title && (
                        <View style={styles.header}>
                            ...
                            <TouchableOpacity testID="modal-close-button" style={styles.closeBtn} onPress={onClose}>
